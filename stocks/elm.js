...
var $author$project$Main$quoteDataDecoder = A3(
	...
	$author$project$Main$QuoteData,
	A2($elm$json$Json$Decode$field, 'price', $elm$json$Json$Decode$float),
	A2($elm$json$Json$Decode$field, 'percent', $elm$json$Json$Decode$float));
...
var $author$project$Main$cachedQuotesDecoder = A2(
	$elm$json$Json$Decode$map,
	A2(
	...
	$elm$json$Json$Decode$maybe(
		A2(
			...
			$elm$json$Json$Decode$nullable(
				$elm$json$Json$Decode$dict($author$project$Main$quoteDataDecoder)))));
var $elm$json$Json$Decode$decodeValue = _Json_run;
var $author$project$Main$cachedQuotesFromFlags = function (flags) {
	var _v0 = A2($elm$json$Json$Decode$decodeValue, $author$project$Main$cachedQuotesDecoder, flags);
	if (!_v0.$) {
		var cache = _v0.a;
		return cache;
	} else {
...
var $author$project$Main$GotKraken = F3(
	function (a, b, c) {
		return {$: 0, a: a, b: b, c: c};
	});
var $author$project$Main$GotYahooSpark = F3(
	function (a, b, c) {
...
var $author$project$Main$fetchQuotes = F2(
	function (attempt, quotes) {
...
var $author$project$Main$quoteWithExistingState = F3(
	function (existingQuotes, cache, quote) {
		var _v0 = $elm$core$List$head(
			A2(
				$elm$core$List$filter,
				function (existing) {
					return _Utils_eq(existing.a, quote.a);
				},
				existingQuotes));
		if (!_v0.$) {
			var existing = _v0.a;
			...
			var _v1 = A2($elm$core$Dict$get, quote.a, cache);
			if (!_v1.$) {
				var cachedData = _v1.a;
...
var $author$project$Main$dedupe = function (values) {
	...
	while (true) {
		if (!values.b) {
			...
			var value = values.a;
			var rest = values.b;
			if (A2($elm$core$List$member, value, rest)) {
				...
				return A2(
					$elm$core$List$cons,
					value,
					$author$project$Main$dedupe(rest));
			}
		}
	}
};
var $author$project$Main$defaultSelectedIds = A2(
	$elm$core$List$map,
	function ($) {
		return $.a;
	},
	...
	function (quoteId, model) {
		...
		if (!_v0.$) {
			...
			return A2(
				...
				$author$project$Main$quoteReadyData,
				A2($author$project$Main$findQuote, quoteId, model.e));
		}
	});
var $elm$core$Basics$neq = _Utils_notEqual;
var $author$project$Main$removeId = F2(
	function (quoteId, values) {
		return A2(
			$elm$core$List$filter,
...
var $author$project$Main$finishFetchFailure = F2(
	function (quoteId, model) {
		var fallbackState = function () {
			var _v0 = A2($author$project$Main$cachedOrCurrentData, quoteId, model);
			if (!_v0.$) {
				var data = _v0.a;
				return $author$project$Main$Ready(data);
			} else {
				return $author$project$Main$Failed('No cached quote');
			}
		}();
		return A4(
...
var $author$project$Main$finishFetchSuccess = F3(
	function (quoteId, data, model) {
		...
		var nextModel = A4(
			$author$project$Main$finishQuoteUpdate,
			A3(
				$author$project$Main$setQuoteState,
				quoteId,
				$author$project$Main$Ready(data),
				model.e),
			nextCache,
			quoteId,
			model);
		return _Utils_Tuple2(
			nextModel,
			$author$project$Main$saveCachedQuotes(
				$author$project$Main$cacheToValue(nextCache)));
	});
var $author$project$Main$maxRetries = 3;
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $author$project$Main$RetryQuote = F2(
	function (a, b) {
		return {$: 2, a: a, b: b};
	});
var $author$project$Main$retryDelayMs = function (attempt) {
	return (attempt * attempt) * 1000;
};
var $elm$core$Process$sleep = _Process_sleep;
var $author$project$Main$scheduleRetry = F2(
	function (quoteId, attempt) {
		return A2(
			$elm$core$Task$perform,
			function (_v0) {
				return A2($author$project$Main$RetryQuote, quoteId, attempt);
			},
			$elm$core$Process$sleep(
				$author$project$Main$retryDelayMs(attempt)));
	});
var $author$project$Main$handleFetchResult = F4(
	function (quoteId, attempt, result, model) {
		if (!result.$) {
			var data = result.a;
...
var $author$project$Main$jsonFromJinaBody = function (body) {
	...
	if (A2($elm$core$String$startsWith, '{', trimmed)) {
		...
		var _v0 = A2($elm$core$String$split, marker, body);
		if (_v0.b && _v0.b.b) {
			var _v1 = _v0.b;
			var json = _v1.a;
			return $elm$core$Maybe$Just(
				$elm$core$String$trim(json));
		} else {
			return $elm$core$Maybe$Nothing;
		}
	}
...
var $author$project$Main$yahooSparkMetaDecoder = A3(
	$elm$json$Json$Decode$map2,
	$author$project$Main$YahooSparkMeta,
	A2($elm$json$Json$Decode$field, 'regularMarketPrice', $elm$json$Json$Decode$float),
	A2($elm$json$Json$Decode$field, 'previousClose', $elm$json$Json$Decode$float));
var $author$project$Main$yahooSparkDecoder = A2(
	...
	A2(
		...
		A2(
			...
			A2(
				$elm$json$Json$Decode$index,
				0,
				A2($elm$json$Json$Decode$field, 'meta', $author$project$Main$yahooSparkMetaDecoder)))));
var $author$project$Main$quoteDataResultFromYahooSpark = function (result) {
	if (!result.$) {
		var body = result.a;
		var _v1 = $author$project$Main$jsonFromJinaBody(body);
		if (!_v1.$) {
			var json = _v1.a;
			return A2(
				$elm$core$Result$mapError,
			...
			return $elm$core$Result$Err('No quote data');
		}
	} else {
		var httpError = result.a;
		return $elm$core$Result$Err(
	...
	function (msg, model) {
		switch (msg.$) {
			...
			case 0:
				...
				var result = msg.c;
				return A4(
					$author$project$Main$handleFetchResult,
					quoteId,
					attempt,
					$author$project$Main$quoteDataResultFromKraken(result),
					model);
			case 1:
				var quoteId = msg.a;
				var attempt = msg.b;
				...
				return A4(
					...
					quoteId,
					attempt,
					$author$project$Main$quoteDataResultFromYahooSpark(result),
					model);
			default:
				var quoteId = msg.a;
				var attempt = msg.b;
...
var $author$project$Main$styleNode = A3(
	$elm$html$Html$node,
	'style',
	_List_Nil,
	_List_fromArray(
...
var $author$project$Main$formatWithDecimals = F2(
	function (decimals, value) {
		var sign = (value < 0) ? '-' : '';
		var factor = A2($elm$core$Basics$pow, 10, decimals);
		var absoluteValue = $elm$core$Basics$abs(value);
		var rounded = $elm$core$Basics$round(absoluteValue * factor);
		var fraction = A3(
			$elm$core$String$padLeft,
			decimals,
			'0',
			$elm$core$String$fromInt(rounded % factor));
		var whole = (rounded / factor) | 0;
		return (!decimals) ? _Utils_ap(
			sign,
			$elm$core$String$fromInt(whole)) : (sign + ($elm$core$String$fromInt(whole) + ('.' + fraction)));
	});
var $author$project$Main$formatPercent = function (percent) {
	var sign = (percent > 0) ? '+' : '';
	return sign + (A2($author$project$Main$formatWithDecimals, 2, percent) + '%');
};
...
var $author$project$Main$viewQuote = function (quote) {
	...
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('quote-row ' + stateClass)
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('symbol')
					]),
				_List_fromArray(
					[
						...
						case 0:
							return _List_fromArray(
								[
									...
									_List_fromArray(
										[
											$elm$html$Html$Attributes$class('price muted')
										]),
									_List_fromArray(
										[
											$elm$html$Html$text('...')
									...
									_List_fromArray(
										[
											$elm$html$Html$Attributes$class('change muted-pill')
										]),
									_List_fromArray(
										[
											$elm$html$Html$text('...')
						...
						case 1:
							...
							return _List_fromArray(
								[
									...
									_List_fromArray(
										[
											$elm$html$Html$Attributes$class('change')
										]),
									_List_fromArray(
										[
											$elm$html$Html$text(
						...
						default:
							...
							return _List_fromArray(
								[
									...
									_List_fromArray(
										[
											$elm$html$Html$Attributes$class('price error-text')
										]),
									_List_fromArray(
										[
											$elm$html$Html$text('--')
									...
									_List_fromArray(
										[
											$elm$html$Html$Attributes$class('change failed-pill')
										]),
									_List_fromArray(
										[
...
var $author$project$Main$viewQuotesPage = function (model) {
	return _List_fromArray(
		[
			A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('quote-list'),
					A2($elm$html$Html$Attributes$attribute, 'aria-label', 'Quote watchlist')
				]),
			$elm$core$List$isEmpty(model.e) ? _List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text('No symbols selected')
						]))
				]) : A2($elm$core$List$map, $author$project$Main$viewQuote, model.e))
		]);
};
...
var $author$project$Main$viewSymbolChoice = F2(
	function (selectedIds, quote) {
		return A2(
			$elm$html$Html$label,
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('symbol-choice')
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('symbol-toggle'),
							$elm$html$Html$Attributes$type_('checkbox'),
							$elm$html$Html$Attributes$checked(
							A2($elm$core$List$member, quote.a, selectedIds)),
							$elm$html$Html$Events$onCheck(
							function (_v0) {
								return $author$project$Main$ToggleSymbol(quote.a);
							})
						]),
					_List_Nil)
				]));
		...
		[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$text(
									$author$project$Main$selectedCountText(model))
								]))
						])),
					A2(
					$elm$html$Html$button,
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('done-button'),
							$elm$html$Html$Events$onClick($author$project$Main$CloseSymbols)
						]),
					_List_fromArray(
						[
		...
		A2(
			...
			function () {
				...
				if (!_v0) {
					...
					return $author$project$Main$viewSymbolsPage(model);
				}
			}()));
};
